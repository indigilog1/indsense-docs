...
1. **Log in** to the device's captive portal using the default credentials.
2. Navigate to the **Settings** tab in the portal interface.
3. Under the password section:
    - Enter the **current password** (default: `12345678`).
